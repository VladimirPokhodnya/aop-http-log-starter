package com.github.vladimirpokhodnya.aophttploggingstarter.aspect.old;
...
public class TaskAspect {
    ...
    @AfterThrowing(
            pointcut = "@annotation(com.github.vladimirpokhodnya.aophttploggingstarter.aspect.old.annotation.LogException)"
    )
    ...
    @AfterReturning(
            pointcut = "@annotation(com.github.vladimirpokhodnya.aophttploggingstarter.aspect.old.annotation.HandlingResult)",
            returning = "result"
    )
    ...
    @Around("@annotation(com.github.vladimirpokhodnya.aophttploggingstarter.aspect.old.annotation.LogTracking)")
